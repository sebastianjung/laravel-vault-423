...
<body>
    ...
    <div id="vault-423">
        <div class="centered-content">
            <h1>
                <span>Hier wird</span>
                <span class="typewriter-js"></span>
            </h1>

            <div class="lock-wrapper">
                    <div class="lock">
                        <input @keyup.enter="submit('{{ request()->url() }}')" @input="removePasswordIncorrectWarning" v-model="password" type="password" name="vault-423-password" placeholder="" tabindex="1"/> 
        ...
        <div class="logo">
            <img src="/vault-423/img/logo" alt="Ultrabold Logo">
        </div>
    </div>
